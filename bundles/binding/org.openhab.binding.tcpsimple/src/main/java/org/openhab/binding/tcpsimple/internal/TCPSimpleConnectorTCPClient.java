 ...
 * @since 1.7.0
 */
public class TCPSimpleConnectorTCPClient extends TCPSimpleConnector {

	private static final Logger logger = LoggerFactory
			.getLogger(TCPSimpleConnectorTCPClient.class);
	...
	public TCPSimpleConnectorTCPClient() {
	}
	...
	public class InputReader extends Thread {
		InputStream in;
		TCPSimpleConnectorTCPClient connector;

		public InputReader(InputStream in, TCPSimpleConnectorTCPClient connector) {
			this.in = in;
