 ...
 * @since 1.7.0
 */
public class TCPSimpleConnectorTCP extends TCPSimpleConnector {

	private static final Logger logger = LoggerFactory
			.getLogger(TCPSimpleConnectorTCP.class);
	...
	public class InputReader extends Thread {
		InputStream in;
		TCPSimpleConnectorTCP connector;

		public InputReader(InputStream in, TCPSimpleConnectorTCP connector) {
			this.in = in;
