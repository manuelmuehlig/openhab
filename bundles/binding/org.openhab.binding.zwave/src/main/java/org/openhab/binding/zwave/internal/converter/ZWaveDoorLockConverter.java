...
import org.openhab.binding.zwave.internal.converter.state.IntegerLockedUnlockedTypeConverter;
...
/***
 * ZWaveDoorLockConverter class. Converter for communication with the 
...
public class ZWaveDoorLockConverter extends ZWaveCommandClassConverter<ZWaveDoorLockCommandClass> {
	 ...
	 */
	public ZWaveDoorLockConverter(ZWaveController controller, EventPublisher eventPublisher) {
		super(controller, eventPublisher);
		
		// State and command converters used by this converter. 
		this.addStateConverter(new IntegerLockedUnlockedTypeConverter());
	}
